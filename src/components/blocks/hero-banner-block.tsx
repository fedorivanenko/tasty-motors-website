...
export const HeroBannerBlock: React.FC<HeroBannerBlockProps> = ({
  ...
  return (
    <section className="relative w-full h-[90vh] overflow-hidden flex items-center justify-center bg-foreground text-background">
      {backgroundImage?.url && (
        <Image
      ...
      <div className="relative z-10 text-center px-6 max-w-3xl">
        ...
        {subheadline && <p className="text-xl md:text-2xl mt-2 uppercase">{subheadline}</p>}
